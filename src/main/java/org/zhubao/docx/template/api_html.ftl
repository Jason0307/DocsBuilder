...
<body>
	...
	<table class="api">
		...
		<tr>
			...
			<td>${apiObject.method} </td>
		</tr>
		<tr>
			<td class="ctp">Mapping</td>
			<td>${apiObject.requestUrl}</td>
		</tr>
		<tr>
            ...
            <#if builderUtil.isVo(parameter.typeClass)><a href="vo.html#${parameter.type}">${parameter.type}</a> ${parameter.name}
           <br/>
            <div>
            	<table class="api param">
            		<tr>
            			<td>Mock Data</td>
            			<td class="mockData">${parameter.mockData!}</td>
            		</tr>
            	</table>
            </div>
            <#else>${parameter.type} ${parameter.name}</#if> 
            </#list>
            </td>
        </tr>
        <tr>
