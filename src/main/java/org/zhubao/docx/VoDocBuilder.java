...
public class VoDocBuilder extends AbstractBaseBuilder {
	...
	String templateFile = "/org/zhubao/docx/template/vo.ftl";
	String packageToFindVo = "org.zhubao.vo";
		...
		while (urls.hasMoreElements()) {
			...
			if (file.exists()) {
				for (String filename : file.list()) {
					...
					if (isMeetRequirement(voClass) && !className.contains("StackBarChartVo") && !className.contains("UserMetricsVo")) {
